          ...
          <div class="col-md-8 col-sm-6"> 
            ...
            <div class="listing events-listing">
              <header class="listing-header">
                <h3 class=" titles">Welcome church management system</h3>
              </header>
			  <?php
              ...
              <section class="listing-cont">
                <ul>
                  <li class="item sermon featured-sermon"> <span class="date"></span>
                    <h4><a href="#">church management system</a></h4>
					<?php
                            //include('../connect.php');
               ...
               ?> 
                  ...
                  <li class="item post">
                    <div class="row">
                      <div class="col-md-12"> <a href="images/download(5).jpg" class="media-box"> <img src="images/download(5).jpg" alt="chm" style="width:90px"> </a></div>
                     </div>
                  </li>
				   <li class="item post">
                    <div class="row">
                      <div class="col-md-12"> <a href="images/download(9).jpg" class="media-box"> <img src="images/download(9).jpg" alt="chm" style="width:90px"> </a></div>
                     </div>
                  </li>
                 </ul>
              </section>
