							...
							<div class="single-bottom">
								<ul>
									<li>
										...
										<label for="brand"><span></span> welcome and be blessed.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand1" value="">
										<label for="brand1"><span></span> be blessed.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand2" value="">
										<label for="brand2"><span></span> welcome.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand9" value="">
										<label for="brand9"><span></span> praise God.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand8" value="">
										<label for="brand8"><span></span> our God is an awsome God.</label>
									</li>
									<li>
									...
									<li>
										...
										<label for="brand4"><span></span> praise God.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand5" value="">
										<label for="brand5"><span></span> hallelujah.</label>
									</li>
									<li>
										<input type="checkbox"  id="brand6" value="">
										<label for="brand6"><span></span> praise God.</label>
									</li>
