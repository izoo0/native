      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-xs-8">
            <h1 class="sido"> <a href="index.php"><img src="images/logo.png" alt="nnn" style="width:90px"></a> </h1>
          </div>
          <div class="col-md-8 col-sm-6 col-xs-4">
            <ul class="top-navigation ">
              <li><a href="donate.php">Tithe and Offering</a></li>
              <li><a href="donate.php">church registry</a></li>
            </ul>
          ...
          <div class="col-md-12">
            <nav class="navigation">
              <ul class="sf-menu">
				...
				<ul class="dropdown">
                    <li><a href="our-excos.php">church management</a></li>
                  </ul>
                </li>
